...
def page_not_found(e):
    return "2017年8月24日付けで本家チュウニズムネットの方で大幅な仕様変更が行われたため本サービスを継続することが困難となりました。<br>したがって本日をもってCHUNITHM Rate Calculatorのサービスを終了したいと思います。<br>1年と半年ほどサービスを続けることができたのはユーザーの皆様のおかげです。今までありがとうございました。<br>CHUNITHM Rate Calculator 製作者:@Akashi_SN"
